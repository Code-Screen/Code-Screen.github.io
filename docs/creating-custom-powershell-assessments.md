...
You can then add the description of your assessment, choose <strong>PowerShell</strong> from the drop-down list of available `DevOps` tools, and set the time limit for the assessment.</br>
...
This repository will simply contain an `PowerShell .gitignore` file and a README containing the description of the assessment that you added during the setup.<br><br>
...
You can then update this repository with details of your `PowerShell` assessment and start sending the assessment to candidates.
