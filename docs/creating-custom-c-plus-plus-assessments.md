...
This repository will simply contain a `C++ .gitignore` file and a README containing the description of the assessment that you added during the setup.<br><br>
