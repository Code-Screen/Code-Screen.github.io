...
<figure>
  ...
  <img src="csharpRepo.png" alt=".NET Repo"/>
</figure>
...
If would like to add tests that are automatically run by CodeScreen against each candidate's solution to your assessment, you can add these as test classes in the `test/` directory.
