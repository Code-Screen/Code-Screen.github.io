...
All unit tests files must use the Angular default [Jasmine](https://angular.io/guide/testing) test framework & [Karma](https://angular.io/guide/testing) assessment runner and all end-to-end assessments must use the [Cypress](https://www.cypress.io/) E2E test framework.
