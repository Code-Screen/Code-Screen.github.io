...
Once this is done, copy the Integration key, go to the <a href="https://app.codescreen.dev/#/client-integrations" target="_blank">Integrations</a> section on the CodeScreen platform and copy your Integration key into the Teamtailor API Key box and click `Save changes`.
