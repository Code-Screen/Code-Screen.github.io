...
This repository will contain a skeleton <strong>React Native</strong> project, and the README will contain the description of the test that you added during the setup.</br></br>

<figure>
  <figcaption style="font-style: italic;">Example custom React Native assessment GitHub repository:</figcaption>
  </br>
  <img src="reactNativeRepo.png" alt="Angular Repo"/>
</figure>
