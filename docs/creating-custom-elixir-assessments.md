...
All assessment filenames must end with `_test.exs` and assessment files with filenames that end with `_hidden_test.exs` will not be visible to the candidate.
