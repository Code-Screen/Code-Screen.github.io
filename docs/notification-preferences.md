...
By default, once a candidate passes/fails one of your assessments, or when an assessment expires, you will be notified by email.

<figure>
  <figcaption style="font-style: italic;">Email Notification:</figcaption>
  </br>
  <img style="max-width: 50%;" src="emailNotification.png" alt="Result"/>
</figure>
